...
namespace NewIdentityCore.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobileNo = table.Column<string>(maxLength: 12, nullable: true),
                    ...
                    LoggedInSessionToken = table.Column<string>(nullable: true),
                    ReferenceId = table.Column<int>(nullable: true),
                    IsLoginPasswords = table.Column<bool>(nullable: true),
                    PasswordFlag = table.Column<bool>(nullable: true)
                },
                constraints: table =>
                {
